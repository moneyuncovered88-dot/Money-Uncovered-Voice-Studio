...
PRESETS: dict[str, Preset] = {
    "mu_storyteller": Preset(
        ...
        settings={"exaggeration": 0.5, "cfg_weight": 0.5, "temperature": 0.7, "speed": 0.85},
    ...
    "mu_storyteller_calm": Preset(
        ...
        settings={"exaggeration": 0.45, "cfg_weight": 0.5, "temperature": 0.7, "speed": 0.8},
    ...
    "mu_storyteller_slow": Preset(
        ...
        settings={"exaggeration": 0.4, "cfg_weight": 0.5, "temperature": 0.65, "speed": 0.75},
